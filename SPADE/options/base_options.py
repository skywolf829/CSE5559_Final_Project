...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--checkpoints_dir', type=str, default=os.path.join(folder_path, "..", "checkpoints"), help='models are saved here')
        ...
        # for setting inputs
        parser.add_argument('--dataroot', type=str, default=os.path.join(folder_path, "..","datasets","cityscapes"))
